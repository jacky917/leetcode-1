...
/**
 * 2024.02.20
 * 時間複雜度 擊敗 7.52% 使用 Java 的用户
 * 空間複雜度 擊敗 5.03% 使用 Java 的用户
 */
class Solution240220 {

    private String[] words;
    private int maxWidth;
    private final HashMap<String,Integer> len = new HashMap<>();
    ...
    public void print(int left, int right) {
        System.out.println("len = " + len.get(left + "," + right));
        for (int i = left; i < right; i++) {
    ...
    public static void main(String[] args) {
        Solution240220 solution240220 = new Solution240220();
        List<String> result = solution240220.fullJustify(new String[]{"Science", "is", "what",
